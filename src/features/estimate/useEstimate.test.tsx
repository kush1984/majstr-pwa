...
function seedEstimate(qc: QueryClient) {
  const est: EstimateResponse = {
    ...
    items: [{
      ...
      quantity: 2, unitPrice: 100, lineTotal: 200, sortOrder: 0, measurementRefs: [], quantityManual: false, percentBaseKind: null, percentBaseItemId: null, baseDetached: false,
    }],
